...
%\newpage
\chapter{Building Vector space Retrieval Model using UIMA}
...
The RetrievalEvaluator is a stub for the evaluation component. You need to finish implementation
...
MRR: 0.334
\end{verbatim}
Your sample report file may look as follows:
\begin{verbatim}
