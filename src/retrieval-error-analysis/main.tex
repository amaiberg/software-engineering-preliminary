...
(note that the dash is converted to the underscore and ID is your SCS/Andrew ID):

\begin{center}\small\textbf{mvn exec:java 
       -Dexec.mainClass=edu.cmu.lti.f14.hw3.hw3\_ID.VectorSpaceRetrieval}\end{center}
...
\textbf{highest} cosine-similarity score and print the following (use one space to separate fields):
\begin{verbatim}
...
However, you can you use a file system.
