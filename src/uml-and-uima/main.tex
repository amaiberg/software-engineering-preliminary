...
\item \textbf{Out: September 8.}\footnote{This version was built on \today}

\item \textbf{Due: September 22.} In addition to all your Java files, UIMA
...
answer UML design related questions, write a \textbf{report} on your implementation of
the named entity recognizer, and include the \textbf{Javadocs}.
...
source code and descriptors, as well as the documents, in the right place of
...
instead we encourage you to place your Java code in the right package, and
...
of you did for Homework 0).  Or you can just report an issue at
